`sisyphus` is intended to be an _agent loop_ whose goal is to utilize minimal llm resources to queue a job, interpret the result, make a change, queue a job...
